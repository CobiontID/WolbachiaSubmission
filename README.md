...
email: email address from where to send emails to ENA taxid requests
taxreq: location of the overview file where to store which taxids are currently being requested
```
